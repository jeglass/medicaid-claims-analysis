...
fig_all <- plot_ly(
  monthly_data_all,
  x = ~year_month, y = ~TOTAL_CLAIMS, color = ~display_label,
  type = 'scatter', mode = 'lines+markers',
  text = ~paste0("<b>", display_label, "</b><br>", "Codes: ", codes, "<br>",
  ...
  layout(
    ...
    hovermode = 'closest',
    legend = list(title = list(text = "<b>Value Set / Code</b>"), orientation = "v",
