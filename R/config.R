...
CHESTNUT_CLAIMS_PARQUET <- "data/chestnut_claims.parquet"
IL_MO_WA_OR_CLAIMS_PARQUET <- "data/il_mo_wa_or_claims.parquet"
BHRN_CLAIMS_PARQUET <- "data/bhrn_claims.parquet"
NPI_PARQUET <- "data/npi/npidata_with_taxonomy.parquet"
CORE_NPI_PARQUET <- "data/npi/core_202509.parquet"
CHESTNUT_NPI_CSV <- "doc/chestnut_npi_full.csv"
IL_MO_WA_OR_NPI_CSV <- "doc/il_mo_wa_or_npi_full.csv"
BHRN_NPI_XLSX <- "doc/bhrn_npi.xlsx"
